...
class JoueurController extends Controller
{
    ...
    */
    public function inscrire(JoueurRequest $request): JsonResponse
    {
        ...
        if ($joueur && $actif) {
            $message = "le joueur est déja existant ou en cours de jouer";
            return Response()->json(["message" =>$message ], 404);
        } else {
